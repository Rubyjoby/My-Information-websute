...
let Sfx = new Audio('sfx/potion1.m4a');
let webScrollContain;
let forestSfx = new Audio('sfx/Forest - Ambient Sound Effects (192K).mp3');
let forestBg = 'url(/storage/emulated/0/Download/UncomfortableWelllitDrever-size_restricted.gif)';
let dropWaterSfx = new Audio('sfx/justADrop.mp3');
